...
const WebApplications = React.memo(() => {
  const navigate = useNavigate();

  const scrollToServices = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const servicesSection = document.getElementById("Webs");
    if (servicesSection) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-blue-100 selection:text-blue-900">
        ...
        <header className="pt-20 pb-6 md:pt-40 md:pb-24 relative overflow-hidden">
          <div className="w-full">
            ...
            >
              ...
              <span className="hidden md:inline">Web Engineering</span>
              <span>©2021</span>
            </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-24">
          ...
          <div className="md:w-2/3">
            <p className="text-lg md:text-xl text-gray-500 font-light leading-relaxed mb-8">
              We don't just build websites; we engineer complex, data-driven web
              applications that power businesses. From robust backends to
              pixel-perfect frontends, we deliver holistic solutions.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-gray-100 mt-6">
              {[
                { label: "Uptime", value: "99.9%" },
                { label: "Faster Load", value: "2x" },
      ...
      {/* 3. Services Grid (Bento Style & Content Rich) */}
      <section id="Webs" className="py-10 md:py-20 px-4 md:px-12 max-w-[1600px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-16 gap-4 md:gap-8">
          ...
          <div className="md:w-1/3">
            <p className="text-gray-500 text-lg font-light leading-relaxed">
              We specialize in crafting bespoke digital experiences. From
              complex enterprise platforms to high-speed consumer apps, our
              stack is built for the future.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[minmax(300px,auto)]">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="w-14 h-14 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 text-2xl">
                <i className="fas fa-layer-group text-[#2f8ecd]"></i>
              </div>
              <h3 className="text-3xl font-bold mb-4">
                Custom Web Applications
              </h3>
              <p className="text-gray-400 leading-relaxed mb-8 max-w-lg">
                We engineer robust, scalable, and secure web applications
                tailored to your specific business needs. From complex internal
                dashboards to client-facing portals, our solutions are built to
                handle high traffic and data intensity with ease.
              </p>

              {/* Visual Mock: System Status */}
              <div className="mb-8 p-4 bg-black/20 rounded-xl border border-white/5 backdrop-blur-sm w-full">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-xs text-gray-300">
                    <span>Frontend Load</span>
                    <div className="h-1.5 w-32 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-[#2f8ecd] w-[45%] rounded-full"></div>
                    </div>
                  </div>
                  <div className="flex justify-between items-center text-xs text-gray-300">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-white/20 transition-all text-xl">
                <i className="fas fa-shopping-bag text-[#2f8ecd] group-hover:text-white transition-colors"></i>
              </div>
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6 group-hover:text-white/80 transition-colors">
                We create high-performance, conversion-optimized storefronts.
                From headless Shopify builds to fully custom WooCommerce
                solutions, we focus on speed and sales.
              </p>
          ...
          >
            <div className="absolute top-8 right-8 bg-green-100 text-green-600 px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider group-hover:bg-white/20 group-hover:text-white transition-colors">
              +128% YoY
            </div>
            <i className="fas fa-cloud text-3xl text-gray-400 mb-4 group-hover:text-white transition-colors"></i>
            ...
            <p className="text-gray-500 text-xs leading-relaxed group-hover:text-white/80 transition-colors mb-4">
              Scalable multi-tenant architectures. We handle the complexity of
              subscription billing, user roles, and data isolation so you can
              focus on growth.
            </p>
            <div className="grid grid-cols-2 gap-2">
              {["Auth", "Billing", "Roles", "API"].map((f, i) => (
                <div
                  key={i}
                  className="flex items-center gap-1.5 text-[14px] text-gray-500 group-hover:text-white/90"
                >
                  <i className="fas fa-check-circle text-[#2f8ecd] text-[8px] group-hover:text-white"></i>{" "}
                  {f}
                </div>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="bg-gray-50 rounded-[2.5rem] p-8 group hover:bg-[#2f8ecd] transition-colors duration-500 relative"
          >
            <div className="absolute top-8 right-8 bg-blue-100 text-[#2f8ecd] px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider group-hover:bg-white/20 group-hover:text-white transition-colors">
              Offline Ready
            </div>
            <i className="fas fa-mobile-alt text-3xl text-gray-400 mb-4 group-hover:text-white transition-colors"></i>
            <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-white transition-colors">
              PWA
            </h3>
            <p className="text-gray-500 text-xs leading-relaxed group-hover:text-white/80 transition-colors mb-4">
              Native-like experiences on the web. Offline capability, push
              notifications, and home screen installation without the app store
              friction.
            </p>
            <div className="flex gap-2">
              <span className="px-2 py-1 border border-gray-200 rounded text-[12px] font-bold text-gray-400 group-hover:border-white/20 group-hover:text-white">
                Installable
              </span>
              <span className="px-2 py-1 border border-gray-200 rounded text-[12px] font-bold text-gray-400 group-hover:border-white/20 group-hover:text-white">
                Offline
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-md group-hover:text-white/80 transition-colors mt-4">
                Secure, scalable cloud infrastructure and seamless 3rd-party
                integrations. We connect your systems for unified data flow.
              </p>
              <div className="flex gap-3 text-[14px] font-mono text-gray-400 group-hover:text-white/60 mt-4">
                <span>REST</span> <span>•</span> <span>GraphQL</span>{" "}
                <span>•</span> <span>AWS</span> <span>•</span>{" "}
                <span>Azure</span>
              </div>
            </div>
            <div className="flex gap-4 opacity-50 group-hover:opacity-100 transition-opacity">
              <i className="fas fa-plug text-2xl group-hover:text-white"></i>
              <i className="fas fa-server text-2xl group-hover:text-white"></i>
              <i className="fas fa-database text-2xl group-hover:text-white"></i>
            </div>
          </motion.div>
      ...
      {/* 4. Process Timeline Information (New Design: The Blueprint) */}
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-32 relative z-10">
          ...
          <div className="md:w-1/3 md:sticky md:top-32 h-fit">
            ...
            <p className="text-gray-500 text-base md:text-lg font-light leading-relaxed mb-4 md:mb-6">
              We follow a rigorous, agile methodology to ensure your product is
              built on time, on budget, and to the highest standard of quality.
            </p>
              ...
              {[
                {
                  ...
                  desc: "We dive deep into your business goals, user needs, and market landscape. This phase sets the foundation for a product that truly solves problems.",
                  icon: "fa-search",
                  bg: "bg-white border-2 border-[#2f8ecd] text-[#2f8ecd]",
                  tags: ["Market Analysis", "User Personas", "Tech Roadmap"],
                },
                {
                  step: "02",
                  title: "UI/UX Design",
                  desc: "Creating intuitive, accessible, and beautiful interfaces. We prototype interactions to ensure the user journey is seamless before a single line of code is written.",
                  icon: "fa-pencil-ruler",
                  bg: "bg-white border-2 border-purple-500 text-purple-500",
                  tags: ["Wireframing", "High-Fidelity UI", "Design System"],
                },
                {
                  step: "03",
                  title: "Agile Development",
                  desc: "Our engineering team builds with clean, scalable code. We use shorter sprints to provide regular updates and adapt to feedback instantly.",
                  icon: "fa-code",
                ...
                },
                {
                  ...
                  desc: "Rigorous QA across devices and scenarios. We ensure a smooth deployment and provide ongoing support to scale your product.",
                  icon: "fa-rocket",
                  bg: "bg-white border-2 border-orange-500 text-orange-500",
                  tags: ["UAT", "Performance Tuning", "Security Check"],
                },
              ].map((item, idx) => (
                <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-base md:text-lg mb-6 md:mb-8 max-w-md font-light">
                We leverage cutting-edge tech stacks to ensure your application
                performs flawlessly under any load.
              </p>
              <button
                onClick={() => navigate("/contact")}
            ...
            <div className="space-y-8">
              {[
                {
                  title: "Agile Development",
                  desc: "Rapid iterations and constant feedback loops.",
                },
                {
                  title: "Clean Code",
                  desc: "Maintainable, scalable, and documented architecture.",
                },
                {
                  title: "User-Centric",
                  desc: "Design-led engineering focused on end-user experience.",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
      ...
      <section className="py-12 md:py-32 px-4 md:px-12 max-w-[1600px] mx-auto text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl sm:text-6xl md:text-9xl font-bold text-gray-900 mb-4 md:mb-8 tracking-tighter leading-[0.9]">
            ...
            <span className="text-[#2f8ecd]">BUILD?</span>
          </h2>
