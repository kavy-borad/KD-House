...
const ProductEngineering = React.memo(() => {
  const navigate = useNavigate();

  const scrollToServices = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const servicesSection = document.getElementById("Product");
    if (servicesSection) {
    ...
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        <header className="pt-20 pb-6 md:pt-40 md:pb-24 relative overflow-hidden">
          <div className="w-full">
            ...
            >
              <span className="text-[#6366f1]">KarmaDude</span>
              <span className="hidden md:inline">Product Engineering</span>
              <span>©2021</span>
            </motion.div>
            ...
            <div className="relative">
              ...
              >
                <h1 className="text-[11vw] sm:text-[12vw] md:text-[11vw] lg:text-[9vw] xl:text-[8vw] leading-[0.85] font-serif italic font-light text-[#6366f1] tracking-tighter z-10">
                  ENGINEERING
                </h1>
                ...
                <div className="mt-2 md:mt-0 md:ml-8 lg:ml-12 max-w-xs md:max-w-sm">
                  ...
                  <div className="mt-3 md:mt-6">
                    <a
                      ...
                      className="inline-flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-gray-900 text-white rounded-full text-xs sm:text-sm font-bold uppercase tracking-widest hover:bg-[#6366f1] transition-all duration-300 group shadow-lg hover:-translate-y-1"
                    >
                      Explore Services
      ...
      <section className="py-8 md:py-16 px-4 md:px-12 max-w-[1600px] mx-auto border-b border-gray-100 relative">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-24">
          <div className="md:w-1/3 relative">
            {/* Decorative dot */}
            <div className="absolute -left-[3.25rem] top-12 w-3 h-3 bg-[#6366f1] rounded-full hidden md:block ring-4 ring-white"></div>
            <span className="text-xs font-bold tracking-[0.2em] text-[#6366f1] uppercase mb-4 block">
              The Philosophy
            </span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
              Innovating <br /> for the{" "}
              <span className="font-serif italic text-gray-400">future.</span>
            </h2>
          </div>
          <div className="md:w-2/3">
            <p className="text-lg md:text-xl text-gray-500 font-light leading-relaxed mb-8">
              True engineering is about foresight. We architect systems that are
              flexible, robust, and ready to handle the scale of tomorrow.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-gray-100 mt-6">
              {[
                ...
                <div
                  key={idx}
                  className="relative pl-4 border-l-2 border-[#6366f1]/20"
                >
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-16 gap-4 md:gap-8">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-semibold text-gray-900 leading-tight">
              Full-Cycle <br />
              <span className="text-[#6366f1] font-serif italic">
                Product Development.
              </span>
            </h2>
          </motion.div>
          <div className="md:w-1/3">
            <p className="text-gray-500 text-lg font-light leading-relaxed">
              From MVP to Enterprise Scale, we provide the technical muscle to
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[minmax(300px,auto)]">
          ...
          >
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#6366f1]/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 group-hover:bg-[#6366f1]/30 transition-all duration-700"></div>

            <div className="relative z-10 h-full flex flex-col">
              <div className="w-14 h-14 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 text-2xl">
                <i className="fas fa-cogs text-[#6366f1]"></i>
              </div>
              <h3 className="text-3xl font-bold mb-4">
                End-to-End Engineering
              </h3>
              <p className="text-gray-400 leading-relaxed mb-8 max-w-lg">
                We handle the entire product lifecycle. From architectural
                design to deployment and maintenance, we ensure your product is
                built on solid foundations.
              </p>

              {/* Visual Mock: System Health */}
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-xs text-gray-300">
                    ...
                    <div className="h-1.5 w-32 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-[#6366f1] w-[98%] rounded-full"></div>
                    </div>
                  </div>
                  <div className="flex justify-between items-center text-xs text-gray-300">
              ...
              <div
                ...
                className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between group-hover:text-[#6366f1] transition-colors cursor-pointer"
              >
                <span className="text-sm font-bold uppercase tracking-widest">
                  Start Building
                </span>
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white group-hover:text-[#6366f1] transition-all">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-1 md:row-span-2 bg-white border border-gray-100 rounded-[2.5rem] p-8 flex flex-col group hover:bg-[#6366f1] hover:border-[#6366f1] transition-all duration-500 relative overflow-hidden"
          >
            {/* Watermark Icon */}
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-12 h-12 bg-indigo-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-white/20 transition-all text-xl">
                <i className="fas fa-server text-[#6366f1] group-hover:text-white transition-colors"></i>
              </div>
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6 group-hover:text-white/80 transition-colors">
                Designing resilient, highly available infrastructure on AWS,
                Azure, or GCP. We optimize for cost-efficiency and speed.
              </p>
              ...
              <div className="mb-6">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    >
                      <div className="w-1.5 h-1.5 bg-[#6366f1] group-hover:bg-white transition-colors rounded-full"></div>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gray-50 rounded-[2.5rem] p-8 group hover:bg-[#6366f1] transition-colors duration-500 relative"
          >
            ...
            <i className="fas fa-cubes text-3xl text-gray-400 mb-4 group-hover:text-white transition-colors"></i>
            ...
            <p className="text-gray-500 text-xs leading-relaxed group-hover:text-white/80 transition-colors mb-4">
              Decoupling monolithic apps into manageable, independently
              deployable services.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gray-50 rounded-[2.5rem] p-8 group hover:bg-[#6366f1] transition-colors duration-500 relative"
          >
            <div className="absolute top-8 right-8 bg-pink-500 text-white px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider group-hover:bg-white/20 transition-colors">
              Upgrade
            </div>
            <i className="fas fa-sync text-3xl text-gray-400 mb-4 group-hover:text-white transition-colors"></i>
            <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-white transition-colors">
              Legacy Modernization
            </h3>
            <p className="text-gray-500 text-xs leading-relaxed group-hover:text-white/80 transition-colors mb-4">
              Updating outdated systems with modern stacks without disrupting
              business operations.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-2 bg-[#6366f1]/5 border border-[#6366f1]/10 rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-8 group hover:bg-[#6366f1] transition-colors duration-500"
          >
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-md group-hover:text-white/80 transition-colors mt-4">
                We don't just build what you ask for; we help you find the best
                solution. We validate ideas, define roadmaps, and ensure market
                fit.
              </p>
              <div className="flex gap-3 text-[14px] font-mono text-gray-400 group-hover:text-white/60 mt-4">
                <span>Proof of Concept</span> <span>•</span> <span>MVP</span>{" "}
                <span>•</span> <span>Roadmapping</span>
              </div>
            </div>
            <div className="flex gap-4 opacity-50 group-hover:opacity-100 transition-opacity">
              <i className="fas fa-lightbulb text-2xl group-hover:text-white"></i>
              <i className="fas fa-chess text-2xl group-hover:text-white"></i>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-400 text-md">
                We love solving the hard stuff.
              </p>
            </div>
            <div className="w-10 h-10 bg-[#6366f1] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      <section className="py-10 md:py-24 px-4 md:px-12 max-w-[1600px] mx-auto bg-white rounded-[2.5rem] relative">
        <div className="flex flex-col md:flex-row gap-8 md:gap-32 relative z-10">
          ...
          <div className="md:w-1/3 md:sticky md:top-32 h-fit">
            <span className="text-xs font-bold tracking-[0.2em] text-[#6366f1] uppercase mb-3 md:mb-6 block">
              The Process
            </span>
            <h2 className="text-3xl md:text-6xl font-semibold leading-tight text-gray-900 mb-4 md:mb-8">
              Concept to <br />
              <span className="text-[#6366f1] font-serif italic">Reality.</span>
            </h2>
            <p className="text-gray-500 text-base md:text-lg font-light leading-relaxed mb-4 md:mb-6">
              A systematic approach to building robust products. We balance
              speed with quality at every step.
            </p>
            <div className="w-20 h-1 bg-[#6366f1]"></div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "We define the problem space and the solution scope. We create technical specifications and choose the right architecture.",
                  icon: "fa-search",
                  bg: "bg-white border-2 border-[#6366f1] text-[#6366f1]",
                  tags: ["Requirements", "Tech Specs", "Architecture"],
                },
                {
                  step: "02",
                  title: "Agile Development",
                  desc: "Building in sprints. We deliver working software frequently, allowing for feedback and pivots as we build deeply technical features.",
                  icon: "fa-code-branch",
                  bg: "bg-white border-2 border-orange-500 text-orange-500",
                  tags: ["Sprints", "CI/CD", "Code Reviews"],
                },
                {
                  step: "03",
                  title: "Quality Engineering",
                  desc: "Automated testing and manual QA to ensure bug-free releases. We test for load, security, and usability.",
                  icon: "fa-shield-alt",
                  bg: "bg-white border-2 border-green-500 text-green-500",
                  tags: ["Automation", "Security Audit", "Load Testing"],
                },
                {
                  step: "04",
                  title: "Launch & Scale",
                  desc: "Deploying to production and monitoring real-world usage. We optimize resources and scale infrastructure as the user base grows.",
                  icon: "fa-rocket",
                  bg: "bg-white border-2 border-purple-500 text-purple-500",
                  tags: ["Deployment", "Monitoring", "SRE"],
                },
              ].map((item, idx) => (
                <motion.div
                ...
                >
                  ...
                  <div className="pt-2">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[#6366f1] transition-colors">
                      {item.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.tags.map((tag, t) => (
                        <span
                          key={t}
                          className="px-3 py-1 bg-gray-50 rounded-lg text-[10px] font-bold uppercase tracking-wider text-gray-500 border border-gray-100 group-hover:border-[#6366f1]/30 group-hover:text-[#6366f1] transition-all"
                        >
                          {tag}
                        </span>
                      ))}
      ...
      >
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#6366f1]/10 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="px-6 md:px-16 max-w-[1600px] mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              ...
              <button
                onClick={() => navigate("/contact")}
                className="px-8 py-4 bg-white text-gray-900 rounded-full font-bold uppercase text-xs tracking-widest hover:bg-[#6366f1] hover:text-white transition-all shadow-lg shadow-white/10 cursor-pointer"
              >
                Start a Project
              </button>
            </div>
            <div className="space-y-8">
              {[
                {
                  title: "Top 1% Talent",
                  desc: "Engineers who have built at scale.",
                },
                {
                  title: "Modern Stack",
                  desc: "We use the best tools for the job.",
                },
                {
                  title: "Ownership",
      ...
      <section className="py-12 md:py-32 px-4 md:px-12 max-w-[1600px] mx-auto text-center relative overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-50/50 rounded-full blur-[120px] -z-10 pointer-events-none"></div>
        ...
        <div className="relative z-10">
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-4 px-10 py-5 bg-[#0a0a0a] text-white rounded-full font-bold uppercase tracking-widest hover:bg-[#6366f1] transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-1 cursor-pointer"
          >
            <span className="text-sm">Let's Collaborate</span>
            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white group-hover:text-[#6366f1] transition-all duration-500 rotate-[-45deg] group-hover:rotate-0">
              <ArrowUpRight className="w-4 h-4" />
            </div>
          </button>
        </div>
